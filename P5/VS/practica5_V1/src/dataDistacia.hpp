/*
    La busqueda se realiza girando de 0 a 180 grados con pasos de 1 y registrando
    en un float vector[180] el valor medido por el sensor ultrasonico para cada
    paso del barrido
